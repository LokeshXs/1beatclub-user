...
export default function Page() {
  return (
    <main className=" min-h-screen bg-primary w-full">
      ...
      <div className=" p-6 container mx-auto text-primary-foreground space-y-6 ">
        ...
        <div className=" space-y-4">
          ...
          <ul className=" space-y-2">
            ...
            <li className=" list-disc list-inside">
              ...
              in this Agreement) refers to 1BeatClub.
            </li>
            <li className=" list-disc list-inside">
            ...
            <li className=" list-disc list-inside">
              Website refers to 1BeatClub, accessible from{" "}
              <Link className=" underline" href={BASE_URL}>
                {BASE_URL}
              </Link>
            </li>
            <li className=" list-disc list-inside">
        ...
        <div className=" space-y-4">
          ...
          <ul className=" space-y-2">
            <li className=" list-disc list-inside">Email address</li>
            <li className=" list-disc list-inside">First name and last name</li>
            <li className=" list-disc list-inside">Usage Data</li>
          </ul>
          ...
          <ul className=" space-y-2">
            <li className=" list-disc list-inside">
              ...
              by:  Us <br /> Purpose: These Cookies are essential to provide You with
