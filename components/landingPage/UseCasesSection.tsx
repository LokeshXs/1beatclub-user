...
const features = [
  {
    ...
    description:
      "Let your guests take control of the playlist, keeping the party vibes high all night.",
    href: "/signin",
    cta: "Try Now",
  ...
  },
  {
    ...
    description:
      "Fuel the workout with songs that everyone finds motivating and energizing.",
    href: "/signin",
    cta: "Try Now",
    ...
    background: (
      <div className=" relative ">
        <Image
          src="/images/usecase2.svg"
          alt=""
          width={400}
          height={400}
          className="  absolute top-0 right-0 opacity-70 max-sm:w-64 group-hover:scale-90 group-hover:-translate-y-4 transition-all duration-300"
        />
      </div>
    ),
  },
  {
    ...
    description:
      "Turn long drives into a group journey with tunes chosen by everyone on board.",
    href: "/signin",
    cta: "Try Now",
      ...
      <div className=" container mx-auto pb-52  max-md:pb-24 px-6 max-sm:px-2 space-y-6 ">
        <RevealUp>
          <div className=" flex flex-col items-center gap-2">
            ...
            <p className=" text-lg text-secondary-foreground/80 italic text-center max-sm:text-sm">
              From parties to study sessions, see how voting music transforms
              any gathering
            </p>
          </div>
        </RevealUp>
